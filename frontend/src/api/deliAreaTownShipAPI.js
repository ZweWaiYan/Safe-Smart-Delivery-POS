import { onlineBaseURL } from '../data/local-data';
  ...
  const BASE_URL = `${onlineBaseURL}/deliareatownship`;
...
// export const fetchDeliAreaTownShip = async () => {
//     const res = await fetch(BASE_URL);
//     if(!res.ok) throw new Error("Failed to fetch DeliAreaTownShip");
//     return res.json();
// }

export const fetchDeliAreaTownShip = async () => request(BASE_URL, "GET");
